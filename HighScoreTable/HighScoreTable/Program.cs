...
namespace HighScoreTable
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("please enter High Score #" + i + ": ");
                HighScores[i] = Utility.ReadInt();
                Console.WriteLine("The Hish Score of: " + HighScores[i] + " has been accepted");
            }
        ...
        static void PrintAray(int[] input)
        {
