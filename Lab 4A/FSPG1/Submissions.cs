...
namespace FSPG1
{
    public class Submissions
    {
        ...
        {
            Add,        // 0, MathOperator.Add
            Subtract,   // 1 MathOperator.Subtract
            Multiply,   // 2 MathOperator.Multiply
            Divide,     // 3 MathOperator.Divide
            Modulo      // 4 MathOperator.Module
        }
        ...
        {
            if (kiloToLb)
                return Math.Round(input * 2.20462);
            else if (!kiloToLb)
                return Math.Round(input * 0.453592);
            return 0;
        }
